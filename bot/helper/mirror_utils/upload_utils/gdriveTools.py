    ...
    def clone(self, link):
        ...
        try:
            ...
            if mime_type == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'<b>𝐅𝐢𝐥𝐞𝐍𝐚𝐦𝐞: </b><code>{meta.get("name")}</code>\n\n<b>𝐒𝐢𝐳𝐞: </b>{get_readable_file_size(self.transferred_size)}'
                msg += '\n\n<b>𝐓𝐲𝐩𝐞: </b>Folder'
                msg += f'\n<b>𝐒𝐮𝐛𝐅𝐨𝐥𝐝𝐞𝐫𝐬: </b>{self.__total_folders}'
                msg += f'\n<b>𝐅𝐢𝐥𝐞𝐬: </b>{self.__total_files}'
                buttons = ButtonMaker()
                durl = short_url(durl)
                ...
                msg += f'<b>𝐅𝐢𝐥𝐞𝐍𝐚𝐦𝐞: </b><code>{file.get("name")}</code>'
                ...
                if mime_type is None:
                    mime_type = 'File'
                msg += f'\n\n<b>𝐒𝐢𝐳𝐞: </b>{get_readable_file_size(int(meta.get("size", 0)))}'
                msg += f'\n\n<b>𝐓𝐲𝐩𝐞: </b>{mime_type}'
                if INDEX_URL is not None:
                    ...
                    if VIEW_LINK:
                        ...
                        urls = short_url(urls)
                        buttons.buildbutton("𝐕𝐢𝐞𝐰 𝐋𝐢𝐧𝐤", urls)
    ...
    def count(self, link):
        ...
        try:
            ...
            if mime_type == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'<b>𝐅𝐢𝐥𝐞𝐍𝐚𝐦𝐞: </b><code>{name}</code>'
                msg += f'\n\n<b>𝐒𝐢𝐳𝐞: </b>{get_readable_file_size(self.__total_bytes)}'
                msg += '\n\n<b>𝐓𝐲𝐩𝐞: </b>Folder'
                msg += f'\n<b>𝐒𝐮𝐛𝐅𝐨𝐥𝐝𝐞𝐫𝐬: </b>{self.__total_folders}'
                msg += f'\n<b>𝐅𝐢𝐥𝐞𝐬: </b>{self.__total_files}'
            else:
